...
struct Easing : public Component {
    float time_progress;
    lm::vec3 from_pos, to_pos;
    lm::vec3 from_rot, to_rot;
    lm::vec3 from_scale, to_scale;
    bool ease_pos, ease_rot, ease_scale;
    float duration;
    EasingMethod actualEasing;
...
template<> struct type2int<Easing> { enum { result = 8 }; };
//UPDATE THIS!
